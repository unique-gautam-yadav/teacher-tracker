...
class StudentLogin extends StatefulWidget {
  ...
  @override
  State<StudentLogin> createState() => _TeacherLoginState();
}

class _TeacherLoginState extends State<StudentLogin> {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const Text("Welcome, enter your phone below"),
                  const FractionallySizedBox(widthFactor: 1),
                  const Spacer(),
                  Center(
                    child: SvgPicture.asset(
                      'assets/svgs/student.svg',
                      height: 200,
                    ),
                  ),
                  const Spacer(),
  ...
  _verifyOtp() async {
    try {
      ...
      await AuthPreferences.setTeacher(false);
